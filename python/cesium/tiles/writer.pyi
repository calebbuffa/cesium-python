...
class TilesetWriter:
    ...
    def write_tileset(
        self, tileset: Tileset, options: TilesetWriterOptions | None = None
    ) -> TilesetWriterResult: ...
...
class SubtreeWriter:
    ...
    def write_subtree_json(
        self, subtree: Subtree, options: SubtreeWriterOptions | None = None
    ) -> SubtreeWriterResult: ...
    def write_subtree_binary(
        self,
        subtree: Subtree,
        buffer_data: bytes,
        options: SubtreeWriterOptions | None = None,
    ) -> SubtreeWriterResult: ...
...
class SchemaWriter:
    ...
    def extensions(self) -> ExtensionWriterContext: ...
    def write_schema(
        self, schema: Schema, options: SchemaWriterOptions | None = None
    ) -> SchemaWriterResult: ...

def write_tileset(
    tileset: Tileset, options: TilesetWriterOptions | None = None
) -> TilesetWriterResult: ...
def write_subtree_json(
    subtree: Subtree, options: SubtreeWriterOptions | None = None
) -> SubtreeWriterResult: ...
def write_schema(
    schema: Schema, options: SchemaWriterOptions | None = None
) -> SchemaWriterResult: ...
