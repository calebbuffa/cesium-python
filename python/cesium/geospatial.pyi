...
class CartographicPolygon:
    ...
    def vertices(self) -> npt.NDArray[np.float64]:
        """Vertices as an (N, 2) float64 array of [longitude, latitude] in radians."""
        ...
    @property
    def indices(self) -> npt.NDArray[np.uint32]:
        """Triangle indices for the triangulated polygon."""
        ...
    def bounding_rectangle(self) -> GlobeRectangle | None: ...
    @staticmethod
    def rectangle_is_within_polygons(
        rectangle: GlobeRectangle,
        cartographic_polygons: list[CartographicPolygon],
    ) -> bool: ...
    @staticmethod
    def rectangle_is_outside_polygons(
        rectangle: GlobeRectangle,
        cartographic_polygons: list[CartographicPolygon],
    ) -> bool: ...
...
class GeographicProjection:
    ...
    MAXIMUM_GLOBE_RECTANGLE: GlobeRectangle
    ...
    @overload
    def project(self, globe_rectangle: GlobeRectangle) -> Rectangle: ...
    @overload
    ...
    @overload
    def unproject(self, rectangle: Rectangle) -> GlobeRectangle: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
...
class WebMercatorProjection:
    ...
    def unproject(self, rectangle: Rectangle) -> GlobeRectangle: ...
    @staticmethod
    def mercator_angle_to_geodetic_latitude(mercator_angle: float) -> float: ...
    @staticmethod
    def geodetic_latitude_to_mercator_angle(latitude: float) -> float: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
